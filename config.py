...
set = 'Floor_Ele'  # Different dataset with different
model_name = ''
...
coordinates = [indices2coordinates(indices_ndarray, stride, input_size, ratios[i]) for i, indices_ndarray in enumerate(indices_ndarrays)] # the coordinate of each window on the image
